        ...
        <div class="card card-signup">
                ...
                <div class="content">
                    ...
                    <div class="input-group">
                        ...
                        <input id="name" type="text" placeholder="Escribe tu nombre...." class="form-control" name="name" value="{{ old('name') }}" required autofocus>
                    </div>
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">
                         ...
                         <input id="email" type="email" placeholder="Escribe tu Correo Electronico" class="form-control" name="email" value="{{ old('email') }}" required>
                    </div>
